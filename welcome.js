...
module.exports = function (client) {
    ...
    client.on("guildMemberAdd", async member => {
      ...
      const channel2 = member.guild.channels.cache.find(ch => ch.name == 'general');
      if(!channel) return channel2.send("There is not channel called welcome to send the welcome embed!");
